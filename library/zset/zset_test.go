...
func TestNew(t *testing.T) {
	...
	if rank == 5 {
		t.Log("Fields:", 1004, "Rank:", rank, "Score:", score, "Extra:", extra)
	} else {
		t.Error("Fields:", 1004, "Rank:", rank, "Score:", score, "Extra:", extra)
	}
	rank, score, extra = s.GetRank(1001, false)
	if rank == 0 {
		t.Log("Fields:", 1001, "Rank:", rank, "Score:", score, "Extra:", extra)
	} else {
		t.Error("Fields:", 1001, "Rank:", rank, "Score:", score, "Extra:", extra)
	}
	rank, score, extra = s.GetRank(-1, false)
	if rank == -1 {
		t.Log("Fields:", -1, "Rank:", rank, "Score:", score, "Extra:", extra)
	} else {
		t.Error("Fields:", -1, "Rank:", rank, "Score:", score, "Extra:", extra)
	}

	id, score, extra := s.GetDataByRank(0, true)
	t.Log("MGet[REVERSE] Rank:", 0, "Index:", id, "Score:", score, "Extra:", extra)
	id, score, extra = s.GetDataByRank(0, false)
	t.Log("MGet[UNREVERSE] Rank:", 0, "Index:", id, "Score:", score, "Extra:", extra)
