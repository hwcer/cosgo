...
type (
	...
	ErrorHandleFunc func(*Context, error)
...
func New(opt ...session.Option) HandlerFunc {
	return NewWithConfig(DefaultConfig, opt...)
}

// NewWithConfig create a session middleware
func NewWithConfig(config Config, opt ...session.Option) HandlerFunc {
