...
// with status code.
func (e *Server) DefaultHTTPErrorHandler(c *Context, err error) {
...
func (e *Server) CONNECT(path string, h HandlerFunc, m ...MiddlewareFunc) {
...
func (e *Server) DELETE(path string, h HandlerFunc, m ...MiddlewareFunc) {
...
// with optional Register-level Middleware.
func (e *Server) GET(path string, h HandlerFunc, m ...MiddlewareFunc) {
	e.Register([]string{http.MethodGet}, path, h, m...)
}

// HEAD registers a new HEAD Register for a path with matching Handler in the
// router with optional Register-level Middleware.
func (e *Server) HEAD(path string, h HandlerFunc, m ...MiddlewareFunc) {
...
// router with optional Register-level Middleware.
func (e *Server) OPTIONS(path string, h HandlerFunc, m ...MiddlewareFunc) {
...
func (e *Server) Any(path string, h HandlerFunc, m ...MiddlewareFunc) {
...
// in the router with optional Register-level Middleware.
func (e *Server) Register(method []string, path string, handler HandlerFunc, middleware ...MiddlewareFunc) {
	e.router.Register(method, path, handler, middleware...)
}

//
func (e *Server) Group(prefix string, i interface{}, middleware ...MiddlewareFunc) *Group {
...
//代理服务器
func (e *Server) Proxy(prefix, address string, middleware ...MiddlewareFunc) *Proxy {
...
func (e *Server) RESTful(prefix string, handle iRESTful, middleware ...MiddlewareFunc) *RESTful {
...
func (e *Server) Static(prefix, root string, middleware ...MiddlewareFunc) *Static {
...
func (e *Server) AcquireContext(w http.ResponseWriter, r *http.Request) *Context {
...
//优雅关闭，等所有协程结束
func (e *Server) Shutdown(ctx stdContext.Context) error {
